...
export default (
    ...
    <svg className="pier-loading-spinner--md -m-l-4" viewBox="0 0 100 100" preserveAspectRatio="xMaxYMid meet">
    <defs>
        <linearGradient id="gradient1" x2="1" y2="0">
            <stop offset="20%" stopColor="#25B9EF" />
            <stop offset="100%" stopColor="#08D18B" />
...
<svg className="pier-loading-spinner--lg -m-l-4" viewBox="0 0 100 100" preserveAspectRatio="xMaxYMid meet">
<defs>
    <linearGradient id="gradient1" x2="1" y2="0">
        <stop offset="20%" stopColor="#25B9EF" />
        <stop offset="100%" stopColor="#08D18B" />
